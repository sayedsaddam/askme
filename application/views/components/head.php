...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?= base_url('questions'); ?>">AskMe</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?= base_url('home/about_us'); ?>">Questions</a></li>
        <li><a href="<?= base_url('home/about_us'); ?>">Answers</a></li>
      </ul>
      <form action="<?= base_url('name_finder/search_names'); ?>" method="GET" class="navbar-form navbar-left">
        <div class="form-group">
          <input type="text" name="name" class="form-control input-sm" placeholder="Search here" required>
        </div>
